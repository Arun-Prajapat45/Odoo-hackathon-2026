...
CREATE TABLE IF NOT EXISTS vehicle (
    ...
    model               VARCHAR(100),
    year                YEAR,
    capacity            DECIMAL(10,2) NOT NULL,       -- max load, kg
    odometer            DECIMAL(12,2) NOT NULL DEFAULT 0,
    fuel_type           ENUM('PETROL','DIESEL','CNG','EV') NOT NULL DEFAULT 'DIESEL',
...
CREATE TABLE IF NOT EXISTS expense (
    ...
    type        ENUM('TOLL','MISC','MAINTENANCE','FUEL') NOT NULL,
...
CREATE TABLE IF NOT EXISTS dashboard_metrics (
    ...
    utilization         DECIMAL(5,2) NOT NULL DEFAULT 0   -- percentage
) ENGINE=InnoDB;
